...
# Importamos request para obtener datos
# Importamos os para crear el directorio
import requests
import os
...
# Agrega los datos al csv
with open(file_path, 'w', newline='') as file:
    file.write(csv_data)

# Crea un pandas con los datos guardados en el csv
...
#     4
# -----------
# Se importa las técnicas de regulación L1(Lasso) y L2(Ridge)
# Evita el sobreajuste y mejora la generalización del modelo
from sklearn.linear_model import Ridge, Lasso

'''
Ridge: la penalización es proporcional a los valores
cuadrados de los coeficientes
'''
model_ridge = Ridge(alpha=1.0) # alpha se encarga de definir qué tan exctricta es la regulación
# Aplica el modelo a los datos
model_ridge.fit(X_train_multi, y_train_multi)

'''
Lasso: la penalización es proporcional a los valores
absolutos de los coeficientes
'''
